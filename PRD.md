...
분석 대상은 한국과 미국 각각 주식 500개와 ETF 최대 150개의 명시적 유니버스로 관리한다.
유니버스 선정은 최근 유동성과 고정 경계 표본을 사용하며 선정 입력·기준일·규칙 버전을
보존한다. 이는 데이터 운영 범위이며 투자 매력도 평가로 사용하지 않는다.
...
뉴스는 장기 원문 저장소를 목표로 하지 않는다. 초기에는 최근 90일 이내의 제목·API 제공
